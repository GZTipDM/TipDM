...
public class PythonInterpreter {
    ...
    private final static String REPORT_DIR = com.tipdm.framework.dmserver.utils.Constants.PYSERVER_COMMON_DIR + "/report/";
    private final static String MODEL_DIR = com.tipdm.framework.dmserver.utils.Constants.PYSERVER_COMMON_DIR + "/model/";
